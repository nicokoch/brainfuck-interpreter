 ...
 */
void
print_current_state (CELL * prog_array, CELL * ptr, int arr_size)
{
 ...
 */
void
print_code_position (char *prog_code, int code_pos)
{
 ...
 */
void
deal_with_error (char *prog_code, int code_index, CELL * prog_array,
		 CELL * ptr)
{
...
struct Command *
new_command (char type, struct Command *parent)
{
 ...
 */
struct Command *
build_command_struct (char *code)
{
 ...
 */
void
destroy_command_struct (struct Command *head)
{
 ...
 */
char *
bf_read_file_and_minimize (char *filename)
{
...
void
bf_destroy_array (CELL * prog_array)
{
  free (prog_array);
}
...
CELL *
bf_execute (char *program, CELL * prog_array, CELL * ptr)
{
